...
<html lang="en">
  ...
  {!! csrf_field() !!}
        ...
        <div class="form-group">
            ...
            <input type="text" name="phonenumber" id ="" class="form-control" placeholder="Phone Number" aria-describedby="helpId" value="{{old('phonenumber')}}">
            <span class="text-danger">
            @php
...
foreach ($errors->get('password_confirmation') as $message) {
 ...
 @endphp
        ...
        <a href="/login"><button type="button" class="btn btn-primary">Login here </button></td></a>
